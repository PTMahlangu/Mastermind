...
def take_turn(code):
    ...
    status = (correct_digits_and_position,correct_digits_only)
    return status
...
def run_game():
    ...
    while not correct and turns < 12:
        score = take_turn(code)
        show_results(score[0],score[1])
        turns += 1
        correct = check_correctness(score[0],turns)
